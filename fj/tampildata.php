    ...
    <div class="card" style="width: 1300;">
      ...
      <h1 style="text-align: center;position: relative;left: 30px">Input Data</h1>
        ...
        <form method="post" action="simpan_data.php" style="background-color: #FEF9EF">
            ...
            <p style="color:#56203D;position: relative; left: 500px;">Gender <select style="position: relative;left: 15px;color:#56203D">
                <option style="color:#56203D">banci</option>
                <option style="color:#56203D">Laki-Laki</option>
                <option style="color:#56203D">Perempuan</option>
            </select></p>
